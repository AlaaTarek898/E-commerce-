...
export default async function About() {
  ...
  return (
    <div>
      {/* first sec */}
    <div className=" flex flex-col justify-between items-center w-10/12 m-auto md:flex-row">
    ...
    {/* seconde sec */}
    <div className=" w-10/12 m-auto grid grid-cols-1 md:grid-cols-4 gap-12 mt-10">
    ...
    <div className=" w-10/12 m-auto grid grid-cols-1 md:grid-cols-3 md:gap-50 mt-10 ">
    <div >
    ...
    {/* four */}
    <div className="w-10/12  m-auto mt-10 flex flex-col gap-6 md:flex-row justify-around">
