...
function ProductDetails_show(param) {
    ...
    const addProduct = async (id)=>{
        ...
        const res = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$services$2f$data$3a$d916b7__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$text$2f$javascript$3e$__["addToCart"])(id, session.token);
        if ((res === null || res === void 0 ? void 0 : res.status) === 'success') {
            var _res_data;
            setNoCartItems(res.numOfCartItems);
            setCartItems(res);
            setPrice(res === null || res === void 0 ? void 0 : (_res_data = res.data) === null || _res_data === void 0 ? void 0 : _res_data.totalCartPrice);
            ...
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$hot$2d$toast$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].error("Failed to add to cart");
        }
    };
    if (!data) return null;
...
_s(ProductDetails_show, "Bw8zjwURKxwNzaKu2IHGvTdoCto=", false, function() {
    return [
...
//# sourceMappingURL=src_e204d05e._.js.map