...
"[project]/src/lib/services/cartClient.services.ts [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function getLoggedCart() {
    try {
        ...
        console.log("🟡 Token inside getLoggedCart:", token); // 👈 شوفي لو فعلاً موجود
        if (!token) {
        ...
        console.log("🟢 API response:", data); // 👈 نعرف هل فعلاً بيوصل ولا لا
...
async function UpdateSpecificItem(param) {
    ...
    const token = localStorage.getItem('token');
    if (!token) {
        console.warn("No token found, cannot update item");
        return null;
    }
    try {
        const res = await fetch("https://ecommerce.routemisr.com/api/v1/cart/".concat(productId), {
...
// import { getLoggedCart } from "@/lib/services/cartClient.services";
// import { createContext, useEffect, useState } from "react";
// import { useSession } from "next-auth/react"; // ✅ مضافة هنا
...
//   try {
//     console.log("Fetching cart..."); // ✅ أول خطوة
//     const data = await getLoggedCart();
//     console.log("Cart response:", data); // ✅ شوفي بيرجع إيه فعلاً
...
//     } else {
//       console.warn("No success status from API");
//       setCartItems(null);
//     }
//   } catch (err) {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "CartContextProvider.useEffect": ()=>{
            async function getCartItems() {
                ...
                // تأكدي إن الكود ده client side فقط
                if ("TURBOPACK compile-time falsy", 0) //TURBOPACK unreachable
                ;
                ...
                console.log("🟡 Token inside getLoggedCart:", token);
                if (!token) {
                    console.warn("⚠️ No token found in localStorage");
                    return; // مهم جدًا عشان ما نندهش API فاضي
                }
                const res = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$services$2f$cartClient$2e$services$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getLoggedCart"])();
...
_s(CartContextProvider, "GFK0CC7GMGqGCJ6zwyfFVjZxPPc=");
...
//# sourceMappingURL=src_9b97672f._.js.map