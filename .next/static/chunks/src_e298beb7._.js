...
async function getLoggedCart() {
    try {
        ...
        const token = session === null || session === void 0 ? void 0 : (_session_user = session.user) === null || _session_user === void 0 ? void 0 : _session_user.token;
        if (!token) {
...
function CartContextProvider(param) {
    ...
    async function getCartItems() {
        try {
            ...
            if (!token) {
                console.warn("⚠️ No token found in localStorage, skipping getCartItems()");
                return;
            }
            // 🟢 استدعي cart
            const data = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$services$2f$cartClient$2e$services$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getLoggedCart"])();
            ...
            if ((data === null || data === void 0 ? void 0 : data.status) === "success") {
                ...
                var _data_data__id;
                setCartid((_data_data__id = data === null || data === void 0 ? void 0 : (_data_data1 = data.data) === null || _data_data1 === void 0 ? void 0 : _data_data1._id) !== null && _data_data__id !== void 0 ? _data_data__id : null);
            } else {
                console.warn("⚠️ Failed to get cart: ", data);
            }
        } catch (err) {
            console.error("❌ Error while fetching cart:", err);
        }
    }
    // 🟡 عند ما المستخدم يكون authenticated
...
_s(CartContextProvider, "U4chnTHmxi+64q1jC+zgj1GHNaw=", false, function() {
    return [
...
//# sourceMappingURL=src_e298beb7._.js.map