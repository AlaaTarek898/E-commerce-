...
function ProductDetails_show({ data }) {
    ...
    const addProduct = async (id)=>{
        const data = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$services$2f$cart$2e$services$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["addToCart"])(id);
        if (data?.status === 'success') {
            setNoCartItems(data.numOfCartItems);
            setCartItems(data);
            setPrice(data?.data?.totalCartPrice);
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$hot$2d$toast$2f$dist$2f$index$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].success('Successfully toasted!');
        }
    };
    if (!data) {
        return null;
...
//# sourceMappingURL=src_app__components_ProductDetails_ProductDetails_show_tsx_d06b4173._.js.map